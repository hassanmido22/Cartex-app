...
class SingleProductItem extends StatefulWidget {
  final Product item;
  final List<Recommendationlist> recommendations;
  const SingleProductItem({Key key, this.item, this.recommendations})
      : super(key: key);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              "${widget.item.price.toStringAsFixed(2)} LE",
                              style: TextStyle(
                                  fontFamily: 'Nunito',
                        ...
                        Flexible(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return RelatedItem(
                                  item: widget.recommendations.elementAt(index),
                                );
                              },
                            ))
                      ],
